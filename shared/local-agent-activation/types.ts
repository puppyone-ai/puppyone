export type ActivationStatus = "preparing" | "installing" | "setup-required" | "authentication-required" | "authenticating" | "verifying" | "ready" | "detected" | "cancelling" | "cancelled" | "failed" | "interrupted";
export type ActivationStep = { id: "prepare" | "install" | "login" | "verify"; status: "pending" | "running" | "complete" | "skipped" | "failed" };
...
export type LocalAgentActivationBridge = {
  ...
  act(request: { operationId: string; action: "cancel" | "login" | "check" | "guide" | "dismiss" }): Promise<ActivationSnapshot>;
