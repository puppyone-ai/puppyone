...
export class PuppyOneAgentAdapter extends PiRpcRuntimeAdapter {
  constructor(options = {}) {
    ...
    if (!profilePath) throw new TypeError("PuppyOne Agent managed profile is unavailable.");
    super({
      ...options,
      ...
      runtimeSetupMessage: "PuppyOne Agent has no configured model provider. Add a provider credential to PuppyOne, then refresh.",
