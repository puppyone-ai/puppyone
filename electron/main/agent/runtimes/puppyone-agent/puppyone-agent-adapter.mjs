...
export class PuppyOneAgentAdapter extends PiRpcRuntimeAdapter {
  constructor(options = {}) {
    ...
    if (!profilePath) throw new TypeError(`${WORKSPACE_AGENT_DISPLAY_NAME} managed profile is unavailable.`);
    super({
      ...options,
      ...
      runtimeLabel: WORKSPACE_AGENT_DISPLAY_NAME,
      ...
      runtimeSetupMessage: `${WORKSPACE_AGENT_DISPLAY_NAME} has no configured model provider. Add a provider credential to PuppyOne, then refresh.`,
