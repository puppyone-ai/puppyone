...
function approvalRequest(event, toolName) {
  ...
  return {
    ...
    kind,
    title,
    description: subject ? String(subject).slice(0, 2_000) : "PuppyOne Agent requested a tool action.",
    reason: "PuppyOne Agent requires approval before commands, file mutations, or non-read-only tools.",
    command,
    arguments: input,
