...
try:
    ...
    raise puppy_exception(6301, "Server Initialization Error", str(e))
...
async def get_data(
    ...
    try:
        ...
        raise puppy_exception(6100, "Error Getting Data from Server", str(e))
    except Exception as e:
        log_error(f"Server Internal Error: {str(e)}")
        raise puppy_exception(6300, "Server Internal Error", str(e))
...
async def send_data(
    ...
    try:
        ...
        raise puppy_exception(6200, "Error Sending Data to Server", str(e))
    except Exception as e:
        log_error(f"Server Internal Error: {str(e)}")
        raise puppy_exception(6300, "Server Internal Error", str(e))
...
if __name__ == "__main__":
    try:
        ...
        raise puppy_exception(6000, "Unexpected Error in Launching Server", str(e))
