    ...
    def save_data(
        ...
        **kwargs
        ...
        if isinstance(data, str):
            ...
            raise puppy_exception(2301, "Unsupported Data Type", f"Data type {type(data).__name__} is unsupported!")

        if not saver_func:
            raise puppy_exception(2302, "Unsupported File Type", f"Type {file_type} is unsupported!")
