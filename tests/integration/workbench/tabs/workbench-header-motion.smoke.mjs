...
const artifacts = path.join(repo, "artifacts/tests/workbench/header-motion");
await mkdir(artifacts, { recursive: true });
app.setPath("userData", await mkdtemp(path.join(os.tmpdir(), "puppyone-header-motion-profile-")));
