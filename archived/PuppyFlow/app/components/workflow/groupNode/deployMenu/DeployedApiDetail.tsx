  ...
  return (
    <div className='py-[16px] px-[16px] overflow-y-auto'>
      ...
      <div className='grid grid-cols-2 gap-0 mb-8 rounded-lg overflow-hidden border border-[#404040]'>
        <div className='p-4 bg-[#1A1A1A]'>
          ...
          <div className='space-y-3 text-[14px] font-medium max-h-[160px] overflow-y-auto pr-1 scrollbar-hide'>
            ...
            {(!currentApiService.inputs ||
              currentApiService.inputs.length === 0) && (
        ...
        <div className='p-4 bg-[#1A1A1A] border-l border-[#404040]'>
          ...
          <div className='space-y-3 text-[14px] font-medium max-h-[160px] overflow-y-auto pr-1 scrollbar-hide'>
            ...
            {(!currentApiService.outputs ||
              currentApiService.outputs.length === 0) && (
              <div className='text-[12px] text-[#808080] py-2 text-center'>
              ...
              <div className='relative'>
                ...
                >
                  {selectedLang === PYTHON && (
                    ...
                    >
                      <path
                        d='M7 1c-3.1 0-2.9 1.35-2.9 1.35l.01 1.4h2.96v.42H2.65s-1.65.17-1.65 3.02c0 3.13 1.53 3.02 1.53 3.02h.9v-1.45s-.05-1.73 1.7-1.73h2.93s1.65.03 1.65-1.6V2.67S10.2 1 7 1zm-1.63.94c.29 0 .53.24.53.53 0 .3-.24.53-.53.53-.3 0-.53-.24-.53-.53 0-.29.24-.53.53-.53z'
                        fill='#387EB8'
                      />
                      <path
                        d='M7 13c3.1 0 2.9-1.35 2.9-1.35l-.01-1.4H6.93v-.42h4.43s1.65.17 1.65-3.02c0-3.13-1.53-3.02-1.53-3.02h-.9v1.45s.05 1.73-1.7 1.73H5.95s-1.65-.03-1.65 1.6v2.67S3.8 13 7 13zm1.63-.94c-.29 0-.53-.24-.53-.53 0-.3.24-.53.53-.53.3 0 .53.24.53.53 0 .29-.24.53-.53.53z'
                        fill='#FFE052'
                      />
                    </svg>
                  )}
                  {selectedLang === JAVASCRIPT && (
                    ...
                    >
                      ...
                      <path
                        d='M6.667 19.333l1.88-1.133c.363.64.693 1.183 1.486 1.183.76 0 1.24-.297 1.24-1.453v-7.863h2.307v7.893c0 2.387-1.4 3.477-3.447 3.477-1.847 0-2.917-.957-3.467-2.107M15.16 19.073l1.88-1.09c.493.807 1.14 1.403 2.28 1.403 1.057 0 1.6-.467 1.6-1.113 0-.774-.613-1.047-1.65-1.494l-.566-.243c-1.633-.693-2.717-1.563-2.717-3.403 0-1.693 1.29-2.983 3.307-2.983 1.433 0 2.463.5 3.207 1.807l-1.757 1.127c-.387-.693-.803-.967-1.45-.967-.66 0-1.08.42-1.08.967 0 .677.42.95 1.387 1.367l.566.243c1.923.823 3.007 1.66 3.007 3.547 0 2.033-1.597 3.15-3.743 3.15-2.1 0-3.457-.997-4.12-2.317'
                        fill='#0D0D0D'
                      />
                    </svg>
                  )}
      ...
      <div className='mb-6 p-4 bg-[#1A1A1A] rounded-[8px] border border-[#404040]'>
        <h3 className='text-[#CDCDCD] text-[14px] mb-3 text-left'>
          API Details
        </h3>
          ...
          <div>
            ...
            <div className='flex items-center mt-1'>
              ...
              <button
                ...
                onClick={() =>
                  navigator.clipboard.writeText(currentApiService.api_id)
                }
              >
                <svg
          ...
          <div>
            ...
            <div className='flex items-center mt-1'>
              <code className='flex-1 p-2 bg-[#252525] rounded text-[12px] text-[#CDCDCD] overflow-x-auto text-left scrollbar-hide'>
                {currentApiService.endpoint ||
                  `${API_SERVER_URL}/api/${currentApiService.api_id}`}
              </code>
              <button
                className='ml-2 p-2 rounded-md hover:bg-[#2A2A2A]'
                onClick={() =>
          ...
          <div>
            ...
            <div className='flex items-center mt-1'>
              ...
              <button
                className='ml-2 p-2 rounded-md hover:bg-[#2A2A2A]'
                onClick={() =>
                  navigator.clipboard.writeText(currentApiService.api_key)
                }
              >
                <svg
                  className='w-4 h-4 text-[#CDCDCD]'
