...
function ChunkingOthersSubMenu({
  nodeType,
  sourceNodeId,
  showMenu,
  createNewConnection,
}: ChunkingOthersSubMenuProps) {
  return (
    <ul
      id='edgeMenu'
        ...
        >
          <div className='w-[30px] h-[30px] bg-[#1C1D1F] flex items-center justify-center rounded-[5px]'>
            ...
            >
              <path
                fill='#CDCDCD'
                d='M4.68 1.633v1.09l-3.285 1.16L4.68 5.047v1.086L.078 4.383v-1l4.602-1.75ZM6.45 6 8.68.066h.925L7.367 6H6.45Zm8.269-2.117-3.29-1.16v-1.09l4.602 1.758v.992l-4.601 1.75V5.047l3.289-1.164Z'
              />
            </svg>
          </div>
          <div className='text-[14px] font-[500] flex items-center justify-center h-full'>
            for HTML
          </div>
        </button>
      </li>
        ...
        >
          <div className='w-[30px] h-[30px] bg-[#1C1D1F] flex items-center justify-center rounded-[5px]'>
            ...
            >
              <path
                fill='#CDCDCD'
                d='M2.974 8H1.572V.803H3.76l1.308 5.659 1.3-5.66H8.53V8h-1.4V3.132c0-.14.002-.335.005-.586a49.2 49.2 0 0 0 .005-.586L5.776 8h-1.46L2.964 1.96c0 .137.001.332.005.586.003.25.005.446.005.586V8Z'
              />
              <path
                stroke='#CDCDCD'
                strokeWidth='1.5'
                d='M13.5 1v6m-3-3 3 3 3-3'
              />
            </svg>
          </div>
          <div className='text-[14px] font-[500] flex items-center justify-center h-full'>
