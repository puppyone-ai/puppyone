      ...
      <div className='flex items-start justify-between pl-[8px] border-b border-[#6D7177]/30 py-1'>
        <div className='flex flex-col min-w-0 gap-1'>
          ...
          <span className='text-[#606060] text-[11px] whitespace-nowrap truncate'>
            Define how the agent can access, insert, or update this context via
            MCP.
          </span>
        </div>
        <button
              ...
              {indexingList.map((item, index) => (
                ...
                >
                  ...
                  ((item as VectorIndexingItem).status === 'done' ||
                    ...
                    <div
                      className={`w-6 h-6 rounded-full border flex items-center justify-center flex-shrink-0 ${(item as VectorIndexingItem).status === 'done' ? 'border-[#39BC66]' : 'border-[#E53935]'}`}
                    >
                      <svg
                        className={`w-4 h-4 transition-colors ${(item as VectorIndexingItem).status === 'done' ? 'text-[#39BC66]' : 'text-[#E53935]'}`}
                        viewBox='0 0 24 24'
                        fill='none'
                        xmlns='http://www.w3.org/2000/svg'
                      >
                        <path
                          d='M12.1699 3L14.768 6.75H9.57185L12.1699 3Z'
                          fill='currentColor'
                        />
                        <path
                          d='M2.58478 18.9505L4.45961 14.6978L7.20515 19.4532L2.58478 18.9505Z'
                          fill='currentColor'
                        />
                        <path
                          d='M22.0848 19.2455L17.4644 19.7482L20.21 14.9928L22.0848 19.2455Z'
                          fill='currentColor'
                        />
                        <path
                          d='M12.1699 14V5'
                        ...
                        />
                        <path
                          d='M12.1699 14L20.1699 18'
                          stroke='currentColor'
                          strokeWidth='2'
                        />
                        <path
                          d='M12.1699 14L4.16992 18'
                          stroke='currentColor'
                          strokeWidth='2'
                        />
                      </svg>
          ...
          <div className='space-y-1 px-1'>
            {createOptions.map(option => (
              <div
                ...
                title={
                  option.id === 'insert' || option.id === 'update'
                    ? 'Coming soon'
                    : undefined
                }
                onClick={e => {
              ...
              >
                ...
                <div className='w-6 h-6 rounded-full border border-[#606060] flex items-center justify-center flex-shrink-0'>
                  {option.id === 'vector' && (
                    <svg
                      className='w-4 h-4 text-[#606060] group-hover:text-[#CDCDCD] transition-colors'
                      viewBox='0 0 24 24'
                      fill='none'
                      xmlns='http://www.w3.org/2000/svg'
                    >
                  ...
                  {option.id === 'update' && (
                    ...
                    >
                      ...
                      />
                      <path
                        d='M4 20h4l9.5-9.5a2 2 0 10-2.828-2.828L5.172 17.172 4 20z'
                        stroke='currentColor'
                        strokeWidth='2'
                        strokeLinecap='round'
                        strokeLinejoin='round'
