      ...
      <>
        ...
        >
          <div className='flex items-center space-x-3'>
            ...
            <div>
              <div
                className={`text-white font-medium ${compact ? 'text-xs' : 'text-sm'}`}
              >
              ...
              <button
                ...
                className={`w-full text-left hover:bg-[#3A3D45] transition-colors flex items-center space-x-3 ${
                  ...
                  selectedType === typeInfo.type
                    ? 'bg-[#3A3D45] border-l-2 border-blue-500'
                    : ''
                }`}
              >
                <span className={compact ? 'text-sm' : 'text-lg'}>
                ...
                <div>
                  ...
                  <div
                    className={`text-[#9CA3AF] ${compact ? 'text-xs' : 'text-xs'}`}
                  >
      ...
      {types.map((typeInfo, index) => (
        ...
        >
          ...
          <div className='flex-1'>
            <div
              className={`text-white font-medium ${compact ? 'text-sm' : 'text-base'}`}
            >
              {typeInfo.label}
              {typeInfo.type === 'text' && (
            ...
            <div
              className={`text-[#9CA3AF] ${compact ? 'text-xs' : 'text-sm'}`}
            >
              {typeInfo.description}
            </div>
          </div>
