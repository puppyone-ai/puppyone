...
interface InviteCodeVerificationProps {
  onVerificationSuccess: () => void;
}

export default function InviteCodeVerification({
  onVerificationSuccess,
}: InviteCodeVerificationProps) {
        ...
        <div className='flex flex-col justify-between w-full text-center'>
          ...
          <div className='flex flex-col space-y-4 gap-[16px]'>
            ...
            <div className='flex justify-center w-full'>
              <Link
                href='https://puppyagent.notion.site/12bbbe13bfbb80abb624ee5788a6f629?pvs=105'
                className='max-w-[188px]'
              >
                <div
                  className='max-w-[188px] px-[16px] py-[8px] bg-[#252628] text-white border-[1px] border-[#494A4C] 
