...
from src.mut_engine.application import transaction_engine as engine_mod
...
from src.mut_engine.domain.intents import TransactionResult


class _FakeConflictTable:
    """In-memory stand-in for the mut_conflicts table.
