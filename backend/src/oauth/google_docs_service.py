...
class GoogleDocsOAuthService:
    """Service for handling Google Docs OAuth flow."""
    ...
    async def get_authorization_url(
        ...
        """Generate Google OAuth authorization URL for Docs."""
        if not state:
    ...
    async def get_connection(self, user_id: str) -> Optional[OAuthConnection]:
        ...
        return await self.repository.get_by_user_and_provider(user_id, "google-docs")

    async def disconnect(self, user_id: str) -> bool:
        """Disconnect Google Docs for user."""
        return await self.repository.delete_by_user_and_provider(user_id, "google-docs")
    ...
    async def refresh_token_if_needed(self, user_id: str) -> Optional[OAuthConnection]:
        """Refresh Google Docs access token when expired."""
