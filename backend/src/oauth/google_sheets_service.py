...
class GoogleSheetsOAuthService:
    """Service for handling Google Sheets OAuth flow."""
    ...
    async def get_connection(self, user_id: str) -> Optional[OAuthConnection]:
        ...
        return await self.repository.get_by_user_and_provider(user_id, "google-sheets")
    ...
    async def refresh_token_if_needed(self, user_id: str) -> Optional[OAuthConnection]:
        """Refresh Google Sheets access token when expired."""
