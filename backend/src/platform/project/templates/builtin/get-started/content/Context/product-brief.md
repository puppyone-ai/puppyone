...
- Record changes as version history so users can inspect, diff, and roll back.
- Keep human work and agent work visible in the same place.
...
## What this starter repo demonstrates
