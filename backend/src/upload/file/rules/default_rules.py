...
import logging
from src.upload.file.rules.schemas import ETLRule, RuleCreateRequest
...
GLOBAL_DEFAULT_RULE_DESCRIPTION = "系统内置的全局默认 ETL 规则（默认跳过 LLM），用于返回 OCR markdown 指针与元信息的稳定 JSON 包装。"
