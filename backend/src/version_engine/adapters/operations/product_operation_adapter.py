...
contract is typed product operations over the Git-native transaction engine.
...
from src.version_engine.services.tree_reader import VersionEntry, VersionTreeReader
...
class ProductOperationAdapter:
    ...
    async def move(
        ...
        try:
            from src.version_engine.services.hooks import post_commit_move
    ...
    def push_and_finalize(self, project_id: str, push_result: dict) -> dict:
        ...
        """
        from src.version_engine.services.hooks import run_post_push_hook
