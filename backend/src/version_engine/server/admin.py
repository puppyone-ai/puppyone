...
All writes (including rollback) go through ProductOperationAdapter → version transaction engine handlers.
...
from src.version_engine.application.tree import read_tree
from src.version_engine.application.git_object_format import encode_object, encode_tree
