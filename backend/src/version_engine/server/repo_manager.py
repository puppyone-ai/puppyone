...
Provides three repo views:
  ...
  - PuppyOneServerRepo -> used by the version transaction engine
...
from src.version_engine.application.merge import ConflictResolver
...
from src.version_engine.server.backends.s3_storage import CachedStorageBackend, S3StorageBackend
from src.version_engine.server.backends.supabase_audit import SupabaseAuditManager
from src.version_engine.server.backends.supabase_history import SupabaseHistoryManager
from src.version_engine.server.backends.supabase_scope import SupabaseScopeBackend
from src.version_engine.server.db_names import PROJECT_WRITE_STATE_RPC
...
class VersionRepoManager:
    ...
    def get_server_repo(
        ...
        *,
        ...
        """Create a PuppyOneServerRepo for version transaction engine handlers.
