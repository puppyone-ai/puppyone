...
* Commit history table — one row per commit, keyed by (project_id, commit_id).
  ...
  (built by :func:`src.version_engine.application.git_object_format.encode_commit` and stored
...
from src.version_engine.server.backends import safe_data as _safe_data
