...
keeps the linear-catch-up semantics usable by the version transaction engine's
...
from src.version_engine.dependencies import get_version_admin_service, get_product_operation_adapter, get_repo_manager
from src.version_engine.history_changes import normalize_history_changes
from src.version_engine.routers._content_helpers import ensure_project_access, ensure_write_access
...
from src.version_engine.server.validation import validate_path
...
async def get_commit_content(
    ...
    from src.version_engine.services.tree_reader import detect_mime, detect_type
