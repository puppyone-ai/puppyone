...
from src.version_engine.application.root_projection import (
...
from src.version_engine.application.git_object_format import decode_commit, decode_tree
...
def _refresh_fs_path_index(
    ...
    try:
        from src.version_engine.services.fs_path_index import (
...
def _promote_to_ancestor_scopes(repo, project_id: str, entry: dict, scope_path: str) -> None:
    ...
    try:
        from src.version_engine.application.parent_scope_promote import promote_to_parents
        promote_to_parents(
            repo,
            project_id=project_id,
