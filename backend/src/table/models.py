...
class Table(BaseModel):
    ...
    id: int = Field(..., description="主键，表示知识库的ID")
    name: Optional[str] = Field(None, description="知识库名称，在MCP服务中可以提供给Agent")
    project_id: Optional[int] = Field(None, description="外键，对应项目表，表示知识库所属的项目ID")
