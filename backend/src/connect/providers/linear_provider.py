...
class LinearProvider(DataProvider):
    ...
    def __init__(self, user_id: str, linear_service: Optional[LinearOAuthService] = None):
    ...
    async def _fetch_issue(self, issue_id: str, headers: Dict[str, str]) -> DataProviderResult:
    ...
    async def _fetch_project(self, project_id: str, headers: Dict[str, str]) -> DataProviderResult:
        ...
        structured_data = [{
            ...
            "lead_email": project.get("lead", {}).get("email") if project.get("lead") else None,
        ...
        return DataProviderResult(
            ...
            description=f"Project in Linear",
            data=structured_data,
            fields=field_definitions,
            structure_info={
                "type": "project",
