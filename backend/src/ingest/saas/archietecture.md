# SaaS Ingest Module Architecture (src/ingest/saas/)

> Note: This module was renamed from `src/import_/` to `src/ingest/saas/` as part of the unified ingest architecture.
> The unified entry point is now at `src/ingest/router.py`.

---

# Original Import Module Architecture
