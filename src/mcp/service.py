...
from src.exceptions import AuthException, BusinessException, NotFoundException, ErrorCode
...
class McpService:
    ...
    async def update_mcp_instance(
        ...
        try:
            ...
            need_restart = target_status == 1 and (instance.status == 0 or config_changed)
    ...
    async def get_mcp_instance_status(self, api_key: str) -> Dict[str, Any]:
        ...
        Returns:
            状态信息字典
        """
        from src.mcp.server.manager.manager import update_instance_status as update_and_restart_mcp_server
    ...
    async def _sync_all_instances_status(self) -> Dict[str, Any]:
        ...
        from src.mcp.server.manager.manager import update_instance_status as update_and_restart_mcp_server
        from src.mcp.server.manager.manager import get_instance_status as get_mcp_server_status
