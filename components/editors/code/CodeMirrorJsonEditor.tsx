...
export function CodeMirrorJsonEditor({ json, onChange, onPathChange }: CodeMirrorJsonEditorProps) {
    ...
    for (let i = 0; i < before.length; i++) {
      ...
      if (char === '"' && (i === 0 || before[i - 1] !== '\\')) {
        ...
        if (!inString && depth > 0) {
          ...
          if (colonIndex !== -1 && (before.indexOf(',', i) === -1 || colonIndex < before.indexOf(',', i))) {
