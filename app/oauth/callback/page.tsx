...
function OAuthCallbackContent() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      try {
        // In development mode with SKIP_AUTH=true, we can skip session validation
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <p style={{ color: '#6b7280', fontSize: '14px' }}>
            {status === "loading" && "Please wait while we connect your Notion account..."}
            {status === "success" && "Your Notion account has been successfully connected."}
            {status === "error" && "There was an error connecting your Notion account."}
          </p>
        </div>
              ...
              <div style={{ textAlign: 'center' }}>
                {workspaceName && (
                  <p style={{
                    ...
                    Connected to workspace: <span style={{ fontWeight: '500' }}>{workspaceName}</span>
                  </p>
                )}
