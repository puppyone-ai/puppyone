...
from app.utils.exception import PuppyException, global_exception_handler
    ...
    def check_environment(cls):
        ...
        with cls._lock:
            ...
            try:
                ...
                endpoint = settings.OLLAMA_ENDPOINT or settings.OLLAMA_API_ENDPOINT or "http://localhost:11434"
...
class OllamaProvider(ProviderInterface):
    ...
    def __init__(self, model_name: str, **kwargs):
        ...
        # Support both OLLAMA_ENDPOINT and OLLAMA_API_ENDPOINT for flexibility
        self.endpoint = kwargs.get("endpoint") or settings.OLLAMA_ENDPOINT or settings.OLLAMA_API_ENDPOINT or "http://localhost:11434"
        # 确保endpoint没有尾随斜杠
