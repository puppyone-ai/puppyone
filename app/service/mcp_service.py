...
class McpService:
    ...
    async def get_mcp_instance_status(self, api_key: str) -> Dict[str, Any]:
        ...
        Returns:
            状态信息字典
        """
        from app.mcp_server.manager.manager import update_instance_status as update_and_restart_mcp_server
    ...
    async def _sync_all_instances_status(self) -> Dict[str, Any]:
        ...
        from app.mcp_server.manager.manager import update_instance_status as update_and_restart_mcp_server
        from app.mcp_server.manager.manager import get_instance_status as get_mcp_server_status
