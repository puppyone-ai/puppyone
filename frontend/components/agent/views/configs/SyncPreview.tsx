  ...
  return (
    <svg width="36" height="40" viewBox="0 0 36 40" fill="none">
      ...
      <text x="18" y="28" textAnchor="middle" fontSize="7" fontWeight="600" fill={accentColor}
        fontFamily="var(--po-font-sans)">{label}</text>
    </svg>
  );
}
...
function ConnectionLine({ direction, isActive }: { direction: string; isActive: boolean }) {
  const color = isActive ? 'var(--po-success)' : 'var(--po-text-subtle)';
  ...
  switch (provider) {
    ...
    case 'supabase': return (
      <svg width={size} height={size} viewBox="0 0 109 113" fill="none">
        ...
        <path d="M45.317 2.07103C48.1765 -1.53037 53.9745 0.442937 54.0434 5.041L54.4849 72.2922H9.83113C1.64038 72.2922 -2.92775 62.8321 2.1655 56.4175L45.317 2.07103Z" fill="var(--po-success)"/>
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', gap: 0 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, width: 72, flexShrink: 0 }}>
          ...
          <div style={{
            fontSize: 11, fontWeight: 500, color: hasTarget ? 'var(--po-text)' : 'var(--po-text-subtle)',
