...
// Webhook config is handled inline here — it is not shown in the type selector
...
const AGENT_CONFIG_MAP: Record<AgentType, React.ComponentType<AgentConfigProps>> = {
  ...
  webhook:  ChatAgentConfig, // fallback — webhook not exposed in the type selector
};
...
// ── Close icon (used only in this file) ────────────────────────
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 16, display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        {/* Active config — each type owns its own sections */}
