...
export default function UserMenuPanel({ isOpen, onClose }: UserMenuPanelProps) {
  ...
  const [activeTab, setActiveTab] = React.useState<'account' | 'about'>('account')
  ...
  const NavBtn = ({ id, label, icon }: { id: 'account' | 'about', label: string, icon?: React.ReactNode }) => (
    <button
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: 'flex', height: '100%', fontSize: '13px', color: '#D4D4D4' }}>
          {/* Left Navigation */}
          <div style={{
            width: '176px',
            height: '100%',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', marginBottom: '12px' }}>
              <div style={{ fontSize: '16px', fontWeight: 600, color: '#e6e6e6' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ fontSize: 18, fontWeight: 700, color: '#e5e5e5' }}>Free</div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
                    ...
                    <div>
                      <div style={{ fontSize: 16, fontWeight: 700, color: '#e5e5e5' }}>PuppyOne</div>
                      <div style={{ fontSize: 12, color: '#8a8a8a' }}>Version 1.0.0</div>
                    </div>
                  </div>

                  {/* Divider */}
                  <div style={{ height: 1, background: '#2a2a2a', margin: '0 0 20px 0' }} />

                  {/* Social Links */}
                  <div style={{ fontSize: 12, fontWeight: 600, color: '#8a8a8a', marginBottom: 12 }}>
                    Connect with us
                  </div>
