        ...
        {isRoot ? (
          <div className='flex items-center gap-2 font-medium text-[#eee]'>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path d="M2 6C2 4.89543 2.89543 4 4 4H9.17157C9.70201 4 10.2107 4.21071 10.5858 4.58579L12.4142 6.41421C12.7893 6.78929 13.298 7 13.8284 7H20C21.1046 7 22 7.89543 22 9V18C22 19.1046 21.1046 20 20 20H4C2.89543 20 2 19.1046 2 18V6Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            Projects
          </div>
        ) : (
        ...
        {isRoot ? (
          ...
          <div className="flex flex-col gap-[1px] px-2">
             {allProjects.map(p => (
               ...
               >
                 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="opacity-70 group-hover:opacity-100">
            ...
            {project.tables && project.tables.length > 0 ? (
              project.tables.map(table => {
                ...
                return (
                  ...
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={clsx(isActive ? "opacity-100" : "opacity-70 group-hover:opacity-100")}>
