...
export function ErrorConsole({ errors, onClear, maxHeight = 200 }: ErrorConsoleProps) {
  ...
  return (
    <>
      ...
      >
        <div style={{ fontSize: 11, color: '#6F7580', textTransform: 'uppercase', letterSpacing: 0.6 }}>
          CONSOLE
        </div>
        {onClear && (
          <button
