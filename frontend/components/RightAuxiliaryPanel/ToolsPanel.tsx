    ...
    <div style={{
      ...
      overflow: 'hidden',
        ...
        <div style={{
          ...
          <div style={{ fontSize: FONT.primary, fontWeight: 600, color: '#e2e8f0' }}>
            Tools
          </div>
        </div>
                  ...
                  <div key={ap.id}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', padding: '8px 12px' }}>
                      {enabledTools.map((tool) => {
                        ...
                        const typeConfig = TOOL_TYPE_CONFIG[tool.backendId] || { label: tool.label, color: '#9ca3af', bg: 'rgba(255,255,255,0.05)' }
                            ...
                            <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 6 }}>
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                ...
                                <div style={{
                                  ...
                                  color: tool.backendId === 'delete' ? '#f87171' : '#a1a1aa', // 文字保持灰色，避免太刺眼
                                  background: tool.backendId === 'delete' ? 'rgba(127, 29, 29, 0.2)' : 'rgba(255, 255, 255, 0.06)',
                                  border: tool.backendId === 'delete' ? '1px solid rgba(248, 113, 113, 0.2)' : '1px solid rgba(255, 255, 255, 0.08)',
                                  whiteSpace: 'nowrap',
                                  flexShrink: 0,
                                }}>
                                  <div style={{
                                    ...
                                    color: tool.backendId === 'delete' ? 'inherit' : '#fb923c',
                                  }}>
                                  ...
                                  {isEditingName ? (
                                    <input
                                      ...
                                      onKeyDown={(e) => {
                                        ...
                                        if (e.key === 'Escape') setEditingToolField(null)
                                      }}
                                      autoFocus
                                      style={{
                                        width: '100%',
                                    ...
                                    <div 
                                      onClick={() => setEditingToolField({ toolId: toolFieldId, field: 'name' })}
                                      style={{ 
                                        display: 'flex', 
                                        alignItems: 'center', 
                                        gap: 6, 
                              ...
                              <div style={{ minWidth: 0 }}>
                                {isEditingDesc ? (
                                  ...
                                  <div 
                                    onClick={() => setEditingToolField({ toolId: toolFieldId, field: 'description' })}
                                    style={{ cursor: 'pointer', width: '100%' }}
                                    title="Click to edit description"
                                  >
                                    <div style={{
                                      fontSize: FONT.secondary,
                                      color: currentDef.description ? '#71717a' : '#3f3f46', // Darker text for description
                                      whiteSpace: 'nowrap',
                                      overflow: 'hidden',
                                      textOverflow: 'ellipsis',
                                      fontStyle: currentDef.description ? 'normal' : 'italic',
                                      lineHeight: '1.4',
                                    }}>
          ...
          <div style={{ 
            ...
            >
              ...
              <span style={{ 
                ...
                {accessPoints.reduce((sum, ap) => 
                  sum + TOOL_DEFS.filter(tool => ap.permissions[tool.backendId]).length, 0
                )} tools
              </span>
            </button>
          </div>
