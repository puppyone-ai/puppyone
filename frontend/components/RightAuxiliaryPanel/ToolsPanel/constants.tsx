...
export const ALL_TOOLS = ['shell_access', ...READ_TOOLS, ...WRITE_TOOLS] as McpToolType[];
...
export const BashIcon = ({ size = 12 }: { size?: number }): React.JSX.Element => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Default Tool Icon
export const DefaultToolIcon = ({ size = 12 }: { size?: number }): React.JSX.Element => (
