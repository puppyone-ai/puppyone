...
export function DashboardView({ projects, loading, onProjectClick, onCreateClick }: DashboardViewProps) {
  if (loading) {
    return (
  ...
  return (
    <div className="flex-1 p-8 overflow-y-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-xl font-semibold text-[#eee] tracking-tight">Organization Overview</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
        ...
        >
          ...
          <span className="text-xs font-medium text-[#444] group-hover:text-[#666]">New Project</span>
        </button>
      </div>
    </div>
  );
