                ...
                style={{
                  ...
                  background:
                    activeBashCount > 0
                      ...
                      : 'transparent',
                  color: !hasBashTools ? '#444' : activeBashCount > 0 ? '#ffa73d' : '#666',
                ...
                style={{
                  ...
                  background:
                    activeToolsCount > 0
                      ? 'rgba(255, 167, 61, 0.12)' // 金橙色 - 和 Editor 统一
                      : 'transparent',
                  color: !hasMcpTools ? '#444' : activeToolsCount > 0 ? '#ffa73d' : '#666',
