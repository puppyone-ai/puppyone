    ...
    <div style={{ padding: '12px', flexShrink: 0, background: '#111111' }}>
      ...
      <div style={{
        ...
        {showMentionMenu && filteredMentionOptions.length > 0 && (
          ...
          >
            <div style={{ padding: '6px 8px', borderBottom: '1px solid #333', fontSize: 11, color: '#666' }}>
              Select data path
            </div>
              ...
              {filteredMentionOptions.map((key, index) => (
                <div
                  ...
                  style={{
                    ...
                    background: index === mentionIndex ? 'rgba(107, 179, 248, 0.2)' : 'transparent',
                    cursor: 'pointer',
        ...
        <div style={{ position: 'relative', minHeight: '28px' }}>
          ...
          >
            {inputValue ? inputValue.split(/(@(?:\[\d+\]|[\w\u4e00-\u9fa5\.\-\_]+)+)/).map((part, i) => {
              ...
              return <span key={i} style={{ color: '#e5e5e5' }}>{part}</span>;
            }) : (
