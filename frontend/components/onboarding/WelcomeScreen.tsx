          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            >
              ...
              >
                ...
                >
                  - Claude Code getting context from Jira & Slack
                </p>
                <p
                  style={{
                    ...textStyle,
                ...
                >
                  - BI Agent understanding your Airtable data
                </p>
                <p
                  style={{
                    ...textStyle,
                ...
                >
                  - Support Bot answering with your latest docs
                </p>
              </motion.div>
            </div>
          </div>
                ...
                >
                  ...
                  >
                    {isLoading ? (
                      ...
                      <PawIcon
                        size={16}
                        color={isHovered ? colors.accent : '#aaa'}
                      />
                    )}
                  </div>
