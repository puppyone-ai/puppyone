...
export const FILE_FORMATS: FileFormat[] = [
  ...
  },
  {
    ...
    mimeTypes: ['text/csv'],
    category: 'data',
    defaultViewer: 'csv-table',
    availableViewers: ['csv-table', 'monaco-code'],
    editable: true,
    ingestStrategy: 'parse-text',
    monacoLanguage: 'plaintext',
  },
  ...
  },
  {
    ...
    mimeTypes: ['text/html'],
    category: 'code',
    defaultViewer: 'html-artifact',
    availableViewers: ['html-artifact', 'monaco-code'],
    editable: false,
    ingestStrategy: 'parse-text',
    monacoLanguage: 'html',
  },
  ...
  // ─── Plain text + extensionless metadata files ──────────────────
  {
    ...
    availableViewers: ['plain-text', 'monaco-code'],
    editable: true,
    ingestStrategy: 'parse-text',
    monacoLanguage: 'plaintext',
  },
