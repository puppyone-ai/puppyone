...
export function EmptyWorkspaceState({
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 py-6 text-center bg-[#0a0a0a] overflow-hidden min-w-0">
      ...
      {/* Action Links */}
      <div className="flex flex-col items-center gap-2 w-full max-w-[520px] min-w-0">
        <button 
          onClick={onConnectClick}
          className="group flex items-center justify-between w-full px-3 py-2.5 rounded-md bg-[#0a0a0a] border border-transparent hover:border-[#27272a] hover:bg-[#141416] transition-all text-left"
        >
          <div className="flex flex-col gap-1.5 min-w-0">
            <div className="text-[13px] font-medium text-[#d4d4d8] group-hover:text-white transition-colors truncate">
              Connect & transform contexts for Agents
            </div>
            <div className="flex items-center gap-1 text-[#52525b] group-hover:text-[#a1a1aa] transition-colors min-w-0">
              <div className="flex items-center gap-2 mr-1 shrink-0">
                <GithubIcon size={12} />
                <NotionIcon size={12} />
                <LinearIcon size={12} />
              </div>
              <span className="text-[11px] font-medium text-[#71717a] group-hover:text-[#a1a1aa] transition-colors shrink-0">100+ Apps</span>
              <span className="text-[11px] opacity-30 mx-0.5 shrink-0 hidden sm:inline">|</span>
              <span className="text-[11px] truncate hidden sm:inline">Transform Software Data into files for Agents</span>
            </div>
          </div>
        </button>
        ...
        <button 
          onClick={onConnectClick}
          className="group flex items-center justify-between w-full px-3 py-2.5 rounded-md bg-[#0a0a0a] border border-transparent hover:border-[#27272a] hover:bg-[#141416] transition-all text-left mt-1"
        >
          <div className="flex flex-col gap-1.5 min-w-0">
            <div className="text-[13px] font-medium text-[#d4d4d8] group-hover:text-white transition-colors truncate">
        ...
        <div className="w-full h-[1px] bg-[#1f1f23] my-1"></div>
