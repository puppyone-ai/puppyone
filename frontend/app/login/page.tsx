    ...
    >
      <div
        style={{
          ...
          padding: 24,
          background:
            'linear-gradient(135deg, rgba(25,25,25,0.98) 0%, rgba(15,15,15,0.98) 100%)',
          boxShadow:
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <button
            ...
            onMouseEnter={e => {
              e.currentTarget.style.background =
                'linear-gradient(135deg, rgba(35,35,35,0.95) 0%, rgba(25,25,25,0.95) 100%)';
          ...
          {error && (
            <div style={{ color: '#f66', fontSize: 12, textAlign: 'center' }}>
              {error}
            </div>
          )}
...
function GoogleIcon() {
  return (
    ...
    >
      <path
        fill='#4285f4'
        d='M533.5 278.4c0-17.6-1.6-34.4-4.6-50.4H272v95.3h147c-6.4 34.6-25.8 63.9-55 83.6l89 69.4c51.8-47.7 80.5-118 80.5-198z'
      />
      <path
        fill='#34a853'
        d='M272 544.3c74.7 0 137.5-24.8 183.3-67.4l-89-69.4c-24.7 16.6-56.3 26.3-94.3 26.3-72.5 0-134-49-155.9-114.9l-92 71.6c41.6 82.5 127.1 153.8 247.9 153.8z'
      />
      <path
        fill='#fbbc04'
        d='M116.1 318.9c-10-29.8-10-62.1 0-91.9l-92-71.6C4 211 0 240.9 0 272.4s4 61.4 24.1 116.9l92-70.4z'
      />
      <path
        fill='#ea4335'
        d='M272 107.7c39.7-.6 77.6 14.7 105.8 42.9l77.5-77.5C395.1 24 334.2 0 272 0 151.2 0 65.7 71.3 24.1 155.5l92 71.6C138 161.3 199.5 107.7 272 107.7z'
      />
    </svg>
  );
}
