...
function TopRightSaveHistoryButton() {
  ...
  const saveButtonLogo = saveState === "idle" ? (<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none" >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 0C1.79086 0 0 1.79086 0 4V10C0 12.2091 1.79086 14 4 14H10C12.2091 14 14 12.2091 14 10V4C14 1.79086 12.2091 0 10 0H4ZM4 2C2.89543 2 2 2.89543 2 4C2 5.10457 2.89543 6 4 6H10C11.1046 6 12 5.10457 12 4C12 2.89543 11.1046 2 10 2H4Z" fill={isHovering ?  "#CDCDCD" : "#6D7177"}/>
  ...
  return (
    ...
    <div className={`font-plus-jakarta-sans  text-[14px] font-normal leading-normal ${saveState === "idle" ? "text-[#6D7177] group-hover:text-main-grey" : saveState === "success" ? "text-main-green group-hover:text-main-green" : "text-main-red   group-hover:text-main-red"}`}>{saveButtonText}</div>
    </button>
  )
}

export default TopRightSaveHistoryButton