...
type TextJsonNodeSettingMenuProps = {
...
function TextJsonNodeSettingMenu({showSettingMenu, clearMenu, nodeid}: TextJsonNodeSettingMenuProps) {
...
export default TextJsonNodeSettingMenu
