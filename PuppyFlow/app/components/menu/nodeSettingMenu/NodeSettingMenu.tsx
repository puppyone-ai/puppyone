...
function NodeSettingMenu({showSettingMenu, clearMenu, nodeid}: NodeSettingMenuProps) {
  ...
  return (
    <ul className={`flex flex-col absolute top-[21px] bg-[#3E3E41] rounded-[4px] left-0 z-[20000] ${showSettingMenu ? "" : "hidden"}`}>
        <li>
            <button className='flex flex-row items-center justify-start px-[11px] pt-[6px] pb-[2px] gap-[8px] w-[108px] h-[24px] bg-[#3E3E41] border-none rounded-t-[4px] '
            onClick={manageInput}>
            ...
            <div className='font-plus-jakarta-sans text-[10px] font-normal leading-normal text-[#BEBEBE]'>
                {searchNode(nodeid)?.isInput ? "unset input" :"set as input"}
            </div>
            </button>
        </li>
        <li>
            <button className='flex flex-row items-center justify-start px-[11px] gap-[8px] w-[108px] h-[20px] bg-[#3E3E41] border-none'
            onClick={manageOutput}>
            <div className='flex items-center justify-center'>
            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8" fill="none">
            ...
            <div className='font-plus-jakarta-sans text-[10px] font-normal leading-normal text-[#BEBEBE]'>
                {searchNode(nodeid)?.isOutput ? "unset output" :"set as output"}
            </div>
            </button>
        </li>
        <li>
            ...
            <div className='font-plus-jakarta-sans text-[10px] font-normal leading-normal text-[#BEBEBE]'>
                {searchNode(nodeid)?.locked ? "Unlock the text" :"Lock the text"}
            </div>
            </button>
        </li>
        <li>
        ...
        <li>
            ...
            <div className='renameButton font-plus-jakarta-sans text-[10px] font-normal leading-normal text-[#BEBEBE]'>
                {searchNode(nodeid)?.editable ? "lock new name" : "rename"}
            </div>
            </button>
        </li>
        <li >
...
export default NodeSettingMenu