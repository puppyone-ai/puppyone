...
function ChunkingOthersSubMenu({nodeType, sourceNodeId, showMenu, createNewConnection}: ChunkingOthersSubMenuProps) {
  ...
  return (
    <ul id="" className={`bg-[#1c1d1f] rounded-[8px] border-solid border-[3px] border-[#42454A] absolute float-start flex flex-col justify-evenly z-[20001] top-[135px] left-[125px] gap-[3px] p-[3px] items-center ${showMenu === 1 ? "" : "hidden"}`} >
            <li>
                ...
                <div className='text-[12px] font-[700] flex items-center justify-center h-full'>for HTML</div>
                </button>
            </li> 
            <li>
                <button className='w-[141px] h-[30px] bg-[#3E3E41] hover:bg-main-orange rounded-[5px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans text-[#CDCDCD] hover:text-[#1C1D1F] py-[3px] pl-[3px] cursor-pointer' onClick={(event) => {
                ...
                <div className='text-[12px] font-[700] flex items-center justify-center h-full'>for Markdown</div>
                </button>
            </li> 
            </ul>
  )
