...
function ChunkingSubMenu({nodeType, sourceNodeId, showMenu, selectedSubMenu, manageTextNodeSubMenu, createNewConnection}: ChunkingSubMenuProps) {
  ...
  return (
    <ul id="" className={`bg-[#1c1d1f] rounded-[8px] border-solid border-[3px] border-[#42454A] absolute float-start flex flex-col justify-evenly z-[20001] top-[85px] left-[135px] gap-[3px] p-[3px] items-center ${showMenu === 1 ? "" : "hidden"}`} >
            <li>
                <button className='w-[121px] h-[30px] bg-[#3E3E41] hover:bg-main-orange rounded-[5px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans text-[#CDCDCD] hover:text-[#1C1D1F] py-[3px] pl-[3px] cursor-pointer' 
                ...
                <div className='text-[12px] font-[700] flex items-center justify-center h-full'>Auto</div>
                </button>
            </li> 
            <li>
                <button className='w-[121px] h-[30px] bg-[#3E3E41] hover:bg-main-orange rounded-[5px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans text-[#CDCDCD] hover:text-[#1C1D1F] py-[3px] pl-[3px] cursor-pointer' onClick={(event) => {
                ...
                <div className='text-[12px] font-[700] flex items-center justify-center h-full'>By length</div>
                </button>
            </li> 
            <li >
                <button className='w-[121px] h-[30px] bg-[#3E3E41] hover:bg-main-orange rounded-[5px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans text-[#CDCDCD] hover:text-[#1C1D1F] py-[3px] pl-[3px] cursor-pointer' 
                ...
                onClick={(event) => {
                    ...
                    <div className='text-[12px] font-[700] flex items-center justify-center h-full'>By character</div>
                </button>
            </li> 
            <li >
                <button className='w-[121px] h-[30px] bg-[#3E3E41] hover:bg-main-orange rounded-[5px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans text-[#CDCDCD] hover:text-[#1C1D1F] py-[3px] pl-[3px] cursor-pointer' 
                ...
                onClick={(event) => {
                    ...
                    <div className='text-[12px] font-[700] flex items-center justify-center h-full'>By LLM</div>
                </button>
            </li> 
            <li>
                <button className={`w-[121px] h-[30px] ${selectedSubMenu === 3 ? "bg-main-orange text-[#1C1D1F]": "bg-[#3E3E41] text-[#CDCDCD]"} rounded-[5px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans py-[3px] pl-[3px] cursor-pointer`} 
