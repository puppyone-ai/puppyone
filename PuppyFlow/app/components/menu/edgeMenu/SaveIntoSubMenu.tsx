...
function SaveIntoSubMenu({nodeType, sourceNodeId, showMenu}: SaveIntoSubMenuProps) {
    ...
    <ul id="edgeMenu" className={`bg-[#1c1d1f] rounded-[8px] border-solid border-[3px] border-[#42454A] absolute float-start flex flex-col justify-evenly z-[20001] top-[180px] left-[135px] gap-[3px] p-[3px] items-center ${showMenu === 1 ? "" : "hidden"}`} >
            <li>
                ...
                <div className='flex items-center gap-[11px] flex-1'>
                  ...
                  <path d="M0.5 0.5H7.56158L11.2806 10.5H0.5V0.5Z" stroke="#CDCDCD"/>
                  <rect x="0.5" y="2.94458" width="11" height="7.55556" fill="#1C1D1F" stroke="#CDCDCD"/>
                  </svg>

                  </div>
                  <div className='text-[12px] font-[700] flex items-center justify-center h-full'>File</div>
                </div>
