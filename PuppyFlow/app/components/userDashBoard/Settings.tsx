...
const Settings: React.FC = () => {
  const { userName, emailNotifications, setEmailNotifications } = useDashboardContext();

  return (
    <div className="space-y-6 max-h-[500px] pr-2">
      <h3 className="text-[18px] font-medium text-white mb-4 sticky top-0 z-10 bg-[#2A2A2A]">User Settings</h3>
      ...
      <div className="py-[8px] overflow-y-auto">
        ...
        {/* Preferences Section */}
        <h4 className="text-[16px] font-medium text-[#AAAAAA] mb-4">Preferences</h4>
