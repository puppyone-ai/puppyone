...
export default function SourceToConfigEdge ({
  ...
  sourcePosition === Position.Bottom ? Position.Top :
  sourcePosition === Position.Left ? Position.Right :
  Position.Left

  const defaultSourceX = sourcePosition === Position.Left ? sourceX + 32 : sourcePosition === Position.Right ? sourceX - 32 : sourcePosition === Position.Top ? sourceX : sourceX

  const defaultSourceY = sourcePosition === Position.Top ? sourceY + 32 : sourcePosition === Position.Bottom ? sourceY - 32 : sourcePosition === Position.Left ? sourceY : sourceY
  ...
  // let defaultTargetX
  // let defaultTargetY
  const defaultTargetWidth = targetNode?.type === "load" ? 80 :
  targetNode?.type === "llm" ? 80 : 
  targetNode?.type === "chunk" ? 80 :
  targetNode?.type === "search" ? 80 :
  targetNode?.type === "code" ? 80 :
  targetNode?.type === "generate" ? 80 :
  targetNode?.type === "embedding" ? 80 :
  targetNode?.type === "modify" ? 80 :
  80

  const defaultTargetHeight = targetNode?.type === "load" ? 48 :
  targetNode?.type === "llm" ? 48 : 
  targetNode?.type === "chunk" ? 48 :
  targetNode?.type === "search" ? 48 :
  targetNode?.type === "code" ? 48 :
  targetNode?.type === "generate" ? 48 :
  targetNode?.type === "embedding" ? 48 :
  targetNode?.type === "modify" ? 48 :
  48
