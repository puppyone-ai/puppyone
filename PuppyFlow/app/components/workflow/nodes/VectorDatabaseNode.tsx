...
type VectorDatabaseNodeProps = NodeProps<Node<{content: string, label: string}>>

function VectorDatabaseNode({data: {content, label}, type, isConnectable, id}: VectorDatabaseNodeProps) {
  ...
  return (
    <div ref={componentRef} className={`w-full h-full  min-w-[176px] min-h-[176px] p-[32px]`}>
       <div id={id} ref={contentRef} className={`w-full h-full min-h-[112px] border-[1.5px] rounded-[8px] p-[16px]  ${getBorderColor()} text-[#CDCDCD] bg-main-black-theme break-words font-plus-jakarta-sans text-[16px] leading-5 font-[400]`} >
