...
type JsonBlockNodeProps = NodeProps<Node<{ content: string, label:string }>>

function JsonBlockNode({isConnectable, id, type, data: {content, label}}: JsonBlockNodeProps ) {
  ...
  return (
    <div ref={componentRef} className="w-full h-full  min-w-[240px] min-h-[304px] p-[32px]">
    <div ref={contentRef} id={id} className={`w-full h-full min-h-[240px] border-[1.5px] rounded-[8px] px-[8px] pt-[32px] pb-[8px]  ${getBorderColor()} text-[#CDCDCD] bg-main-black-theme break-words font-plus-jakarta-sans text-base leading-5 font-[400] overflow-hidden`}  >
