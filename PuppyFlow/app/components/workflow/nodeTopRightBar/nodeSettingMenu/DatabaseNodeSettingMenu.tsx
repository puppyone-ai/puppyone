...
function DatabaseNodeSettingMenu({showSettingMenu, clearMenu, nodeid}: DatabaseNodeSettingMenuProps) {
  ...
  return (
    <ul className={`flex flex-col absolute top-[21px] bg-[#3E3E41] rounded-[4px] left-0 z-[20000] ${showSettingMenu ? "" : "hidden"}`}>
        ...
        <li>
            <button className='flex flex-row items-center justify-start px-[11px] py-[2px] gap-[9px] w-[108px] h-[20px] bg-[#3E3E41]'
        ...
        <li >
            <button className='flex flex-row items-center justify-start px-[11px] pt-[2px] pb-[6px] gap-[7px] w-[108px] h-[24px] bg-[#3E3E41] rounded-b-[4px]' onClick={deleteNode}>
                <div className='flex items-center justify-center'>
