  ...
  return (
    <div className="py-[16px] px-[16px] overflow-y-auto scrollbar-hide">
            ...
            <div className="flex items-center gap-2">
              <div className="relative">
                ...
                >
                  ...
                  <svg className={`w-4 h-4 transition-transform ${isLangSelectorOpen ? 'rotate-180' : ''}`} fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="space-y-4">
        <div>
          <label className="text-[12px] text-[#808080] text-left block">Chatbot ID:</label>
          <div className="flex items-center mt-1">
            ...
            >
              <svg className="w-4 h-4 text-[#CDCDCD]" fill="currentColor" viewBox="0 0 20 20">
                <path d="M8 2a1 1 0 000 2h2a1 1 0 100-2H8z" />
                <path d="M3 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v6h-4.586l1.293-1.293a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L10.414 13H15v3a2 2 0 01-2 2H5a2 2 0 01-2-2V5zM15 11h2a1 1 0 110 2h-2v-2z" />
              </svg>
            </button>
        ...
        <div>
          <label className="text-[12px] text-[#808080] text-left block">Chatbot Endpoint:</label>
          <div className="flex items-center mt-1">
            ...
            <button
              className="ml-2 p-2 rounded-md hover:bg-[#2A2A2A]"
              onClick={() => {
                navigator.clipboard.writeText(chatbotService.endpoint || `${API_SERVER_URL}/api/${chatbotService.chatbot_id}`);
              }}
            >
              <svg className="w-4 h-4 text-[#CDCDCD]" fill="currentColor" viewBox="0 0 20 20">
                <path d="M8 2a1 1 0 000 2h2a1 1 0 100-2H8z" />
        ...
        <div>
          <label className="text-[12px] text-[#808080] text-left block">Chatbot Key:</label>
          <div className="flex items-center mt-1">
            <code className="flex-1 p-2 bg-[#252525] rounded text-[12px] text-[#CDCDCD] overflow-x-auto text-left scrollbar-hide">
