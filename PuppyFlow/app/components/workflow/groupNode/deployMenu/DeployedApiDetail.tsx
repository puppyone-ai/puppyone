...
`;
  ...
  return (
    <div className="py-[16px] px-[16px] overflow-y-auto"> {/* 移除 max-h-[80vh] 限制 */}
      {/* 头部导航 */}
      ...
      <div className="mb-6 p-4 bg-[#1A1A1A] rounded-[8px] border border-[#404040]">
        <h3 className="text-[#CDCDCD] text-[14px] mb-3 text-left">API Details</h3>
        
        <div className="space-y-3">
          <div>
            <label className="text-[12px] text-[#808080] text-left block">API ID:</label>
          ...
          <div>
            <label className="text-[12px] text-[#808080] text-left block">API Endpoint:</label>
            <div className="flex items-center mt-1">
          ...
          <div>
            <label className="text-[12px] text-[#808080] text-left block">API Key:</label>
            <div className="flex items-center mt-1">
              <code className="flex-1 p-2 bg-[#252525] rounded text-[12px] text-[#CDCDCD] overflow-x-auto text-left scrollbar-hide">
                {currentApiService.api_key}
              </code>
              <button
                className="ml-2 p-2 rounded-md hover:bg-[#2A2A2A]"
                onClick={() => navigator.clipboard.writeText(currentApiService.api_key)}
              >
                <svg className="w-4 h-4 text-[#CDCDCD]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8 2a1 1 0 000 2h2a1 1 0 100-2H8z" />
                  <path d="M3 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v6h-4.586l1.293-1.293a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L10.414 13H15v3a2 2 0 01-2 2H5a2 2 0 01-2-2V5zM15 11h2a1 1 0 110 2h-2v-2z" />
