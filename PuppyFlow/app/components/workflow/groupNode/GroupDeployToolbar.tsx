...
export function GroupDeployToolbar({ groupNodeId, onClose }: GroupDeployToolbarProps) {
        ...
        return (
          <div className="py-[16px] px-[16px]">
            ...
            {(deployedServices.apis.length > 0 || deployedServices.chatbots.length > 0) && (
              <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-[#808080] text-[14px] font-normal">Deployed Services</h3>
                  <button
            ...
            <div className={`${(deployedServices.apis.length > 0 || deployedServices.chatbots.length > 0) ? 'border-t border-[#404040] pt-4' : ''}`}>
              <h3 className="text-[#808080] text-[14px] font-normal mb-4 text-left">Create New Deployment</h3>
