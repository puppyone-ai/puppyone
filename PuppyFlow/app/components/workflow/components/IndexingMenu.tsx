...
const IndexingMenu: React.FC<IndexingMenuProps> = ({
  ...
  // 使用新的数据路径处理hook
  const { keyResult, valueResult, generatePreviewData } = useDataPathProcessor(
    sourceData,
    currentSourceIndex,
    keyPath,
    valuePath
  ...
  return (
    ...
    >
      <div
        className={`absolute top-[40px] ${!showSubPage ? 'right-[-350px] w-[360px]' : 'right-[-540px] w-[420px]'} p-[12px] bg-[#252525] border-[1px] border-[#404040] rounded-[8px] shadow-lg shadow-black/20 z-[20000] flex flex-col gap-3`}
      >
        {/* 主页面 */}
        {!showSubPage ? (
          <>
                    ...
                    <div className='bg-[#1E1E1E] rounded-[6px] border border-[#404040]/30 overflow-hidden flex flex-col h-[160px] mb-3'>
                      <div className='px-2 py-1 bg-[#1E1E1E] border-b border-[#404040]/30 flex items-center justify-between'>
                        <div className='text-[11px] font-medium text-[#CDCDCD]'>
                          Chunk Raw Data:{' '}
                          <span className='text-[#9B7EDB] font-semibold'>
                            {' '}
                    ...
                    <div className='flex flex-row gap-2'>
                      ...
                      <div className='w-1/2 flex flex-col gap-2'>
                        <div className='bg-[#1E1E1E] rounded-[6px] border border-[#404040]/30 overflow-hidden'>
                          ...
                          <div
                            className={`transition-all overflow-hidden ${showKeyPathEditor ? 'max-h-[400px]' : 'max-h-0'}`}
                          >
                            <div className='p-2'>
                              <AdvancedPathEditor
                                path={keyPath}
                      ...
                      <div className='w-1/2 flex flex-col gap-2'>
                        <div className='bg-[#1E1E1E] rounded-[6px] border border-[#404040]/30 overflow-hidden'>
                          <div
                            className='px-2 py-1 bg-[#2A2A2A] hover:bg-[#303030] border-b border-[#404040]/30 flex items-center justify-between cursor-pointer relative transition-colors'
                            onClick={() =>
                              setShowValuePathEditor(!showValuePathEditor)
                            }
                          >
                            <div className='w-1 h-[12px] absolute left-[4px] top-1/2 transform -translate-y-1/2 rounded-sm bg-[#39BC66]'></div>
                            <div className='text-[11px] font-medium text-[#CDCDCD] ml-3'>
                          ...
                          <div
                            className={`transition-all overflow-hidden ${showValuePathEditor ? 'max-h-[400px]' : 'max-h-0'}`}
                          >
                            <div className='p-2'>
                              <AdvancedPathEditor
                                path={valuePath}
