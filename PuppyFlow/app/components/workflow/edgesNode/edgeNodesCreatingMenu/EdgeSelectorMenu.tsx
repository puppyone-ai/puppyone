...
function EdgeMenu1({ nodeType, sourceNodeId }: EdgeMenuProps) {
  ...
  const createNewConnection = (
    ...
    const defaultSourceNodeWidth =
      sourceNode.type === 'text'
        ? 240
        : sourceNode.type === 'structured'
          ? 240
          : sourceNode.type === 'none'
            ? 240
            : sourceNode.type === 'switch'
              ? 176
              : sourceNode.type === 'file'
                ? 208
                : sourceNode.type === 'weblink'
                  ? 208
                  : sourceNode.type === 'vector'
                    ? 176
                    : sourceNode.type === 'vector_database'
                      ? 176
                      : sourceNode.type === 'database'
                        ? 176
                        : 176;

    const defaultSourceNodeHeight =
      sourceNode.type === 'text'
        ? 240
        : sourceNode.type === 'structured'
          ? 240
    ...
    if (
      ...
      xshift =
        handlePosition === Position.Top || handlePosition === Position.Bottom
          ? defaultSourceNodeWidth / 2 - defaultTargetWidth / 2
          : handlePosition === Position.Left
            ? -defaultSourceNodeWidth / 2 - defaultTargetWidth
            : handlePosition === Position.Right
              ? (defaultSourceNodeWidth * 3) / 2
              : 0;
      ...
      yshift =
        handlePosition === Position.Left || handlePosition === Position.Right
          ? defaultSourceNodeHeight / 2 - defaultTargetHeight / 2
          : handlePosition === Position.Top
            ? -defaultSourceNodeHeight / 2 - defaultTargetHeight
            : handlePosition === Position.Bottom
              ? (defaultSourceNodeHeight * 3) / 2
              : 0;
    }
  ...
  const updateEdgeMenuStyle = (): CSSProperties => {
    ...
    if (!node || activatedNode?.id !== sourceNodeId)
      return {
        height: '0px',
        visibility: 'hidden',
        border: 'none',
  ...
  switch (nodeType) {
    case 'text':
      return (
        <div ref={mainMenuRef} style={updateEdgeMenuStyle()}>
          <ul
            ref={edgeMenuRef}
            id='edgeMenu'
            className={` w-[196px] bg-[#1c1d1f] rounded-[16px] p-[8px] border-solid border-[3px] border-[#42454A] absolute float-start flex flex-col justify-evenly z-[20001] gap-[8px] py-[11px] items-start `}
            style={{
              position: 'absolute',
              visibility: 'visible',
              ...edgeMenuStyle,
          ...
          >
            ...
            <li className='w-full relative'>
              <button
                className={`w-full h-[38px]  ${selectedSubMenu === 0 ? 'bg-main-orange text-[#1C1D1F]' : 'bg-[#3E3E41] text-[#CDCDCD]'} rounded-[8px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans py-[4px] pl-[4px] cursor-pointer`}
                onMouseEnter={() => manageTextNodeSubMenu('LLMsub1')}
                onClick={event => {
                  event.preventDefault();
                  event.stopPropagation();
                  createNewConnection('llmnew');
                }}
              >
                ...
                <div className='text-[14px] font- flex items-center justify-center h-full'>
                  LLM
                </div>
              </button>
            </li>
            ...
            <li className='w-full relative'>
              <button
                className={`w-full h-[38px] ${selectedSubMenu === 1 ? 'bg-main-orange text-[#1C1D1F]' : 'bg-[#3E3E41] text-[#CDCDCD]'} rounded-[8px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans py-[4px] pl-[4px] cursor-pointer`}
              ...
              >
                ...
                <div className='h-full w-[7px] flex items-center justify-center mr-[9px]'>
                  ...
                  >
                    <path
                      d='M1 1L5 5L1 9'
                      stroke={selectedSubMenu === 1 ? '#1C1D1F' : '#CDCDCD'}
                      strokeWidth='2'
                    />
                  </svg>
                </div>
              ...
              <ModifySubMenu
                ...
                showMenu={selectedSubMenu === 1 ? 1 : 0}
            ...
            <li className='w-full relative'>
              <button
                className={`w-full h-[38px] ${selectedSubMenu === 2 || selectedSubMenu === 3 ? 'bg-main-orange text-[#1C1D1F]' : 'bg-[#3E3E41] text-[#CDCDCD]'} rounded-[8px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans py-[4px] pl-[4px] cursor-pointer`}
                ...
                <div className='h-full w-[7px] flex items-center justify-center mr-[9px]'>
                  ...
                  >
                    <path
                      d='M1 1L5 5L1 9'
                      stroke={
                        selectedSubMenu === 2 || selectedSubMenu === 3
                          ? '#1C1D1F'
                          : '#CDCDCD'
                      }
                      strokeWidth='2'
              ...
              <ChunkingSubMenu
                ...
                sourceNodeId={sourceNodeId}
                showMenu={
                  selectedSubMenu === 2 || selectedSubMenu === 3 ? 1 : 0
                }
                manageTextNodeSubMenu={manageTextNodeSubMenu}
            ...
            <li className='w-full relative'>
              <button
                className={`w-full h-[38px] ${selectedSubMenu === 11 ? 'bg-main-orange text-[#1C1D1F]' : 'bg-[#3E3E41] text-[#CDCDCD]'} rounded-[8px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans py-[4px] pl-[4px] cursor-pointer`}
              ...
              >
                ...
                <div className='h-full w-[7px] flex items-center justify-center mr-[9px]'>
                  ...
                  >
                    <path
                      d='M1 1L5 5L1 9'
                      stroke={selectedSubMenu === 11 ? '#1C1D1F' : '#CDCDCD'}
                      strokeWidth='2'
                    />
                  </svg>
                </div>
            ...
            <li className='w-full relative'>
              <button
                className={`w-full h-[38px] ${selectedSubMenu === 12 ? 'bg-main-orange text-[#1C1D1F]' : 'bg-[#3E3E41] text-[#CDCDCD]'} rounded-[8px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans py-[4px] pl-[4px] cursor-pointer`}
            ...
            <li className='w-full relative'>
              <button
                className={`w-full h-[38px]  ${selectedSubMenu === 4 ? 'bg-main-orange text-[#1C1D1F]' : 'bg-[#3E3E41] text-[#CDCDCD]'} rounded-[8px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans py-[4px] pl-[4px] cursor-pointer`}
              ...
              >
                ...
                <div className='h-full w-[7px] flex items-center justify-center mr-[9px]'>
                  ...
                  >
                    <path
                      d='M1 1L5 5L1 9'
                      stroke={selectedSubMenu === 4 ? '#1C1D1F' : '#CDCDCD'}
                      strokeWidth='2'
                    />
                  </svg>
                </div>
              ...
              <SearchSubMenu
                nodeType={nodeType}
                sourceNodeId={sourceNodeId}
                showMenu={selectedSubMenu === 4 ? 1 : 0}
                createNewConnection={createNewConnection}
                parentMenuRef={mainMenuRef} // 传递主菜单引用
              />
            </li>
            ...
            <li className='w-full'>
              <button
                className={`w-full h-[38px] ${selectedSubMenu === 9 ? 'bg-main-orange text-[#1C1D1F]' : 'bg-[#3E3E41] text-[#CDCDCD]'} rounded-[8px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans py-[4px] pl-[4px] cursor-pointer`}
            ...
            <li className='w-full relative'>
              ...
              >
                <div className='flex items-center gap-[11px] flex-1'>
                  ...
                  <div className='text-[14px]  items-center justify-center h-full'>
                    Modify
                  </div>
                </div>
                <div className='h-full w-[7px] flex items-center justify-center mr-[9px]'>
            ...
            <li className='w-full relative'>
              <button
                ...
                onClick={event => {
                  event.preventDefault();
                  event.stopPropagation();
                  createNewConnection('retrieving');
                }}
              >
                <div className='flex items-center gap-[11px] flex-1'>
                  <div className='w-[30px] h-[30px] bg-[#1C1D1F] flex items-center justify-center rounded-[5px]'>
      ...
      return (
        <div ref={mainMenuRef} style={updateEdgeMenuStyle()}>
          ...
          >
            ...
            <li className='w-full'>
              <button
                className={`w-full h-[38px] ${selectedSubMenu === 10 ? 'bg-main-orange text-[#1C1D1F]' : 'bg-[#3E3E41] text-[#CDCDCD]'} rounded-[8px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans py-[4px] pl-[4px] cursor-pointer`}
