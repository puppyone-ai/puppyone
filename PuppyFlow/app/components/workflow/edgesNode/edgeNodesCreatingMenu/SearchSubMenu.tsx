...
function SearchSubMenu({
  ...
  return (
    ...
    >
      ...
      <li className='w-full'>
        <button
          className='group w-full h-[38px] bg-[#3E3E41] hover:bg-main-orange rounded-[8px] flex flex-row items-start gap-[11px] font-plus-jakarta-sans text-[#CDCDCD] hover:text-[#1C1D1F] py-[4px] pl-[4px] cursor-pointer'
          onClick={event => {
            event.preventDefault();
            event.stopPropagation();
        ...
        >
          ...
          <div className='text-[14px]  flex items-center justify-center h-full group-hover:text-[#1C1D1F]'>
            Google
          </div>
        </button>
      </li>
