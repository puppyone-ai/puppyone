...
function CopyEdgeNode({ data: { subMenuType }, isConnectable, id }: ModifyConfigNodeProps) {
    ...
    return (
        <div className='p-[3px] w-[80px] h-[48px] relative'>
            ...
            <button
                className={`absolute -top-[40px] left-1/2 transform -translate-x-1/2 w-[57px] h-[24px] rounded-[6px] border-[1px] text-[10px] font-[600] font-plus-jakarta-sans flex flex-row items-center justify-center gap-[4px] transition-all duration-200 ${(isHovered || isRunButtonHovered) ? 'opacity-100' : 'opacity-0'
                    }`}
                style={{
            ...
            >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 12 12" fill="none">
                    <path d="M8 1H2C1.45 1 1 1.45 1 2V8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
