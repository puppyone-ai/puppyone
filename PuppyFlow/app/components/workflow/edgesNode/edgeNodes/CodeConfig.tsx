...
import CodeConfigMenu from '@/app/components/workflow/edgesNode/edgeNodeConfig/CodeConfigMenu'
import { useReactFlow } from '@xyflow/react'

export type CodeConfigNodeData = {
    looped: boolean | undefined,
    code: string | null,
    resultNode: string | null
}

type CodeConfigNodeProps = NodeProps<Node<CodeConfigNodeData>>

function CodeConfig({isConnectable, id, data:{code}}: CodeConfigNodeProps) {
    ...
    return (
        ...
        <CodeConfigMenu show={activatedEdge === id ? true : false} parentId={id} />
        </div>
