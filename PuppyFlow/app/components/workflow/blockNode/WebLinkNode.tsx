...
function WebLinkNode({
  data: { content, label, isLoading, locked, isInput, isOutput, editable },
  isConnectable,
  id,
  type,
}: WebLinkNodeProps) {
  ...
  const renderTagLogo = () => {
    if (locked)
      ...
      return (
        ...
        >
          <path
            d='M8.5 14V10L11.1667 12L8.5 14Z'
            fill='#6C98D5'
            stroke='#6C98D5'
          />
          <path d='M9 11.9961L4 12.001' stroke='#6C98D5' stroke-width='2' />
          <path
            d='M13.5 7H9.5V5.5H15.5V18.5H9.5V17H13.5H14V16.5V7.5V7H13.5Z'
            fill='#6C98D5'
            stroke='#6C98D5'
          />
        </svg>
      ...
      return (
        ...
        >
          <path
            d='M12.5 14V10L15.1667 12L12.5 14Z'
            fill='#FF9267'
            stroke='#FF9267'
          />
          <path d='M13 11.9961L8 12.001' stroke='#FF9267' stroke-width='2' />
          <path
            d='M6.5 7H10.5V5.5H4.5V18.5H10.5V17H6.5H6V16.5V7.5V7H6.5Z'
            fill='#FF9267'
            stroke='#FF9267'
          />
        </svg>
      ...
      return (
        ...
        >
          <path
            d='M5.5 4.5H8.5V7.5H5.5V4.5Z'
            className='fill-[#6D7177] group-hover:fill-[#CDCDCD] group-active:fill-[#4599DF]'
          />
          <path
            d='M5.5 16.5H8.5V19.5H5.5V16.5Z'
            className='fill-[#6D7177] group-hover:fill-[#CDCDCD] group-active:fill-[#4599DF]'
          />
          <path
            d='M11.5 16.5H14.5V19.5H11.5V16.5Z'
            className='fill-[#6D7177] group-hover:fill-[#CDCDCD] group-active:fill-[#4599DF]'
          />
          <path
            d='M11.5 10.5H14.5V13.5H11.5V10.5Z'
            className='fill-[#6D7177] group-hover:fill-[#CDCDCD] group-active:fill-[#4599DF]'
          />
          <path
            d='M5.5 10.5H8.5V13.5H5.5V10.5Z'
            className='fill-[#6D7177] group-hover:fill-[#CDCDCD] group-active:fill-[#4599DF]'
          />
          <path
            d='M11.5 4.5H14.5V7.5H11.5V4.5Z'
            className='fill-[#6D7177] group-hover:fill-[#CDCDCD] group-active:fill-[#4599DF]'
          />
        </svg>
      );
    ...
    if (measureSpanRef.current) {
      if (isInput || isOutput || locked) {
        if (contentRef.current) {
          if (
            measureSpanRef.current.offsetWidth + 21 >
            contentRef.current.clientWidth - 32
          ) {
            // console.log("hello")
  ...
  return (
    <div
      ref={componentRef}
      className={`relative w-full h-full min-w-[144px] min-h-[144px]  ${isOnGeneratingNewNode ? 'cursor-crosshair' : 'cursor-default'}`}
    >
      <div
        id={id}
        ref={contentRef}
        className={`w-full h-full min-h-[144px] min-w-[144px] border-[1.5px] rounded-[16px] p-[8px]  ${borderColor} text-[#CDCDCD] bg-main-black-theme break-words font-plus-jakarta-sans text-[16px] font-[400]`}
      >
        ...
        <svg
          ...
          viewBox='0 0 14 14'
          fill='none'
          className='fixed bottom-[8px] right-[8px]'
        >
          <path
            fillRule='evenodd'
            clipRule='evenodd'
