...
export function useFileUpload({
  ...
  const processFile = async (file: File) => {
    try {
      ...
      const supportedFileExtensions = ["json", "txt", "html", "css", "js", "png", "jpg", "gif", "svg", "mp3", "wav", "mp4", "webm", "pdf", "zip", "md", "markdown", "application", "csv", "xlsx", "xls", "xlsm", "xlsb", "ods", "doc", "docx"];
