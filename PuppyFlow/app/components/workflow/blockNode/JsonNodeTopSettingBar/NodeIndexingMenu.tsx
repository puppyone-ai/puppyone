...
const IndexingMenu: React.FC<IndexingMenuProps> = ({
  ...
  const embeddingModels = useMemo(() => {
    return availableModels.filter(
      model => model.active && model.type === 'embedding'
    );
  }, [availableModels]);
  ...
  const mapModelToDisplay = (model: any) => {
    ...
    return (
      <span className='text-[#CDCDCD] text-[12px] font-medium'>
        {model.name}
      </span>
    );
  };
                      ...
                      <div className='flex flex-col gap-1'>
                        ...
                        <div className='relative h-[32px] bg-[#252525] rounded-[6px] border-[1px] border-[#6D7177]/30 hover:border-[#6D7177]/50 transition-colors'>
                          <PuppyDropdown
                            ...
                            onSelect={(selectedModel: any) =>
                              setSelectedEmbeddingModel(selectedModel)
                            }
                            buttonHeight='32px'
                        ...
                        {selectedEmbeddingModel && (
                          <div className='text-[10px] text-[#6D7177] flex items-center gap-2 mt-1'>
                            ...
                            <span>•</span>
                            <span>
                              {selectedEmbeddingModel.isLocal
                                ? 'Local'
                                : 'Cloud'}
                            </span>
                            <span>•</span>
