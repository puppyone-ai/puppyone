      ...
      <div className='w-full h-full border-[1px] border-[#303030] bg-[#181818] rounded-[8px] flex items-center justify-center'>
        <div className='w-full max-w-[960px] h-full px-6 md:px-10 lg:px-16 flex flex-col font-plus-jakarta-sans'>
          <div className='flex-1 flex flex-col items-center justify-center text-center gap-4 py-10'>
            <svg width='112' height='94' viewBox='0 0 223 188' fill='none' xmlns='http://www.w3.org/2000/svg' className='opacity-80'>
              <path d='M131.621 62.5L137.428 68.3066L137.489 68.8223L142.489 110.822L142.555 111.372L131.803 127.5H92.1973L81.4453 111.372L81.5107 110.822L86.5107 68.8223L86.5723 68.3066L92.3789 62.5H131.621Z' fill='#FFA73D' stroke='#1C1D1F' strokeWidth='3'/>
              <path d='M113 105.001L113 108.63C112.999 110.151 112.383 111.617 111.28 112.72L110.408 113.592C109.494 114.506 108.299 115.116 107.001 115.333L106.206 115.465C104.201 115.799 102.162 115.161 100.762 113.762L99.0002 112' stroke='#1C1D1F' strokeWidth='3'/>
              <path d='M113 104L113 108.657C113 110.162 113.603 111.604 114.685 112.686L115.623 113.624C116.518 114.518 117.688 115.115 118.966 115.328L119.772 115.462C121.788 115.799 123.856 115.145 125.28 113.721L127 112' stroke='#1C1D1F' strokeWidth='3'/>
              <path d='M125.381 80L117.381 86L125.5 91.5' stroke='#1C1D1F' strokeWidth='3'/>
              <path d='M99.3813 80L107.381 86L99.3813 92' stroke='#1C1D1F' strokeWidth='3'/>
              <path d='M151.584 60.7565L155.093 91.5572L141.183 93.142L137.674 62.3413L151.584 60.7565Z' fill='#FFA73D' stroke='#1C1D1F' strokeWidth='4'/>
              <path d='M86.0931 62.3405L82.5838 93.1413L68.6738 91.5564L72.1831 60.7557L86.0931 62.3405Z' fill='#FFA73D' stroke='#1C1D1F' strokeWidth='4'/>
            ...
            >
              <svg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg' className='opacity-90'>
                <rect x='2.25' y='2.25' width='13.5' height='13.5' rx='3' stroke='currentColor' />
            ...
            {isWorkspaceLimitReached && (
              <span className='text-[12px] text-[#6A6A6A]'>You have reached your plan limit.</span>
            )}
          </div>
                ...
                >
                  <div className='flex items-center gap-3'>
                    <div className='w-[36px] h-[36px] rounded-[8px] bg-[#222222] border border-[#2B2B2B] flex items-center justify-center'>
                      <svg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg' className='opacity-80'>
                        <rect x='2.25' y='2.25' width='13.5' height='13.5' rx='3' stroke='#7C7C7C' />
