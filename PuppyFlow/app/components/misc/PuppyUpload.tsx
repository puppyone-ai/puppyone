    ...
    <>
          ...
          >
            {uploadedFiles.map(
              (
                ...
                >
                  <span className='truncate max-w-[calc(100%-28px)] overflow-hidden text-ellipsis'>
      ...
      {ReactDOM.createPortal(
        <input
          ...
          accept='.json, .pdf, .txt, .doc, .docx, .csv, .xlsx, .markdown, .md, .mdx'
          multiple
