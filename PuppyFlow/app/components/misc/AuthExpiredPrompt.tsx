...
const AuthExpiredPrompt: React.FC<AuthExpiredPromptProps> = ({ visible, onLogin, onDismiss }) => {
      ...
      >
        <div className="px-4 pt-3 pb-2">
          <div className="flex items-start gap-2">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-1 flex-shrink-0">
              <path d="M12 3L21 18H3L12 3Z" fill="white" stroke="white" strokeWidth="0.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M12 12V8" stroke="#FF3A3A" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
