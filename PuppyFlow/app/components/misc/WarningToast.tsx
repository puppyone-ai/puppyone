  ...
  return (
    <div className='fixed bottom-[32px] right-[16px] max-w-[400px] min-w-[200px] flex flex-col gap-2 z-50'>
      {warns.length > 1 && (
        <button
          onClick={clearWarns}
          className='self-end flex items-center gap-1.5 mb-1.5 text-xs bg-red-500/90 hover:bg-red-600 text-white py-2 px-4 rounded-full shadow-md transition-all duration-200 border border-red-400/30 hover:shadow-lg'
          title='清除所有警告'
        >
          <svg
            width='14'
