    ...
    const onDrop = useCallback((acceptedFiles: any) => {
      ...
      return (
        ReactDOM.createPortal(
          <>
          <button onClick={open} className='absolute top-[40%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 text-pink-300  border-2 border-pink-300 rounded-md px-2 py-1'>Click me </button>
