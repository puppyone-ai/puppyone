...
Sync a local directory to the cloud via the MUT protocol:

```bash
# Create a filesystem connection (specify scope path)
puppyone access add filesystem docs

# Follow the output's mut clone command to clone locally
